<?php
	...
	//todo: change userid to current SESSION userid
	$uid = $_SESSION['userid'];
	$bottleSQL ="SELECT * FROM bottle WHERE bottleid IN ( SELECT bottleid FROM follow WHERE userid = '$uid' )";
	
	//$bottleSQL ="SELECT * FROM bottle WHERE bottleid IN ( SELECT bottleid FROM follow WHERE userid = 2 )";
